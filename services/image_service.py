...
def _image_items(start_date: str = "", end_date: str = "", media_type: str = "image") -> list[dict[str, object]]:
    items = []
    root = config.images_dir
    _MEDIA_EXTS = {".mp3", ".mp4", ".wav", ".webm", ".ogg", ".mov", ".avi", ".aac", ".flac"}
...
def list_images(base_url: str, start_date: str = "", end_date: str = "", media_type: str = "image") -> dict[str, object]:
    ...
    items = [
        ...
        for item in _image_items(start_date, end_date, media_type)
    ]
