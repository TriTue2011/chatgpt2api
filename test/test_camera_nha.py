...
class UrlCoThamSoTests(unittest.TestCase):
    ...
    DAHUA = "rtsp://admin:Anhnhi%400610@10.0.0.9/cam/realmonitor?channel=1&subtype=0"
    ...
    def test_mat_khau_co_dau_a_coi_gõ_thang_van_tach_dung_host(self) -> None:
        ...
        ra = cam.che_bi_mat("rtsp://admin:Anhnhi@0610@10.0.0.9/cam/realmonitor?channel=1")
