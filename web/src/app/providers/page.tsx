  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-1 border-b border-black/[0.04] pb-5">
        <h1 className="text-[24px] font-bold tracking-tight text-[var(--foreground)]">{t("providersTitle")}</h1>
            ...
            >
              ...
              <div className="mb-3 flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-[var(--foreground)]">{meta.label}</h3>
                    <p className="text-xs text-[var(--muted-foreground)]">{meta.desc}</p>
                  </div>
                </div>
                <span
                  className={cn(
              ...
              <div className="flex items-center gap-2">
                {provider.name === "opencode" && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--secondary)] px-3 py-1.5 text-xs font-medium text-[var(--foreground)] transition hover:bg-[var(--secondary)] disabled:opacity-50"
                  >
                    {isTesting ? (
                ...
                {provider.name === "opencode" && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="ml-auto text-xs text-[var(--muted-foreground)] transition hover:text-[var(--foreground)]"
                  >
