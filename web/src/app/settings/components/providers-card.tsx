      ...
      <CardContent className="space-y-6 p-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-[var(--foreground)]">Nhà cung cấp AI</h3>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <Sliders className="size-5 text-[var(--foreground)]" />
            <h3 className="text-sm font-semibold text-[var(--foreground)]">Backend mặc định</h3>
          </div>
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <div className="space-y-1">
              ...
              <select value={backends.default_image || "1792x1024"}
                ...
                className="w-full h-9 rounded-lg border-[var(--border)] text-sm bg-[var(--card)]">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <Sliders className="size-5 text-[var(--foreground)]" />
            <h3 className="text-sm font-semibold text-[var(--foreground)]">Rate Limit Backoff</h3>
          </div>
          <div className="grid gap-3 md:grid-cols-3">
            {[
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <Combine className="size-5 text-[var(--foreground)]" />
            <h3 className="text-sm font-semibold text-[var(--foreground)]">Combo Models</h3>
          </div>
