...
const KHO: Record<string, {
  ...
  drive: {
    cacBuoc: [
      ...
      "Mở cửa sổ dòng lệnh, chạy: rclone authorize \"drive\"",
      "Trình duyệt tự mở ra — đăng nhập tài khoản Google, rồi bấm Cho phép.",
      ...
      "Muốn giới hạn bot chỉ dùng một thư mục: mở thư mục đó trên Drive, nhìn thanh địa chỉ .../folders/<mã> rồi dán mã vào ô «Mã thư mục gốc».",
    ],
    nhan: "Google Drive",
    loai: "drive",
