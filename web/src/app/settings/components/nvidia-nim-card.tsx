    ...
    <Card className="rounded-2xl card-3d card-tint-emerald">
      <CardContent className="space-y-4 p-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-[var(--foreground)]">NVIDIA NIM</h3>
          <span className="text-[10px] text-[var(--muted-foreground)]">build.nvidia.com</span>
        </div>
        ...
        <div className="p-3 rounded-lg bg-[var(--secondary)] text-xs text-[var(--muted-foreground)] space-y-1">
          <p><strong>Chat:</strong> Dùng prefix <code className="bg-[var(--secondary)] px-1 rounded">nv/</code> — ví dụ: <code className="bg-[var(--secondary)] px-1 rounded">nv/openai/gpt-oss-120b</code></p>
          <p><strong>Tạo ảnh:</strong> Dùng prefix <code className="bg-[var(--secondary)] px-1 rounded">nv-image/</code> — ví dụ: <code className="bg-[var(--secondary)] px-1 rounded">nv-image/black-forest-labs/flux.2-klein-4b</code></p>
          <p><strong>Vision:</strong> Dùng model vision qua <code className="bg-[var(--secondary)] px-1 rounded">nv/google/gemma-4-31b-it</code></p>
        </div>
