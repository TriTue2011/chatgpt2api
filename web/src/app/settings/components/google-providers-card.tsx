      ...
      <CardContent className="space-y-5 p-5">
        ...
        <div className="space-y-3 rounded-xl border-2 border-blue-300 bg-[var(--card)]/60 p-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button className="h-9 rounded-lg border border-blue-200 bg-[var(--card)] px-3 text-xs text-blue-700" onClick={()=>void moNoVNC()}><ExternalLink className="size-3.5 mr-1"/>Mở noVNC</Button>
