    ...
    return (
      <Card className={className}>
        <button
          ...
          className="w-full flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-4 py-2.5 text-xs font-semibold text-muted-foreground hover:text-foreground"
        >
