...
_IMAGE_GEN_PROVIDER_PREFIXES = {
    ...
    "recraft/",      # Recraft
    "runwayml/",     # RunwayML
    # NOTE: flow/, gma/, gpt-, gemini-, gma/ intentionally NOT here
    # — only specific models from these providers generate images
    # and they are explicitly listed in IMAGE_MODELS above.
}
...
# Flow video generation model prefix
_VIDEO_GEN_PREFIXES: set[str] = {
    "flow/veo",       # Veo 3.1 family
    "flow/omni",      # Omni Flash
}
